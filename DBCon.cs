...
namespace Reconocimiento_facial
{
    public class DBCon
    {
        ...
        public DBCon()
        {
            conn = new OleDbConnection("Provider = Microsoft.Jet.OLEDB.4.0; Data Source = UsersFaces.mdb");
            conn.Open();
        }

        public bool GuardarImagen(string Name, string Code, byte[] abImagen,string  telefono, string correo)
        {
            conn.Open();
            OleDbCommand comm = new OleDbCommand("INSERT INTO UserFaces (Name,Code,telefono,correo,Face) VALUES " +
                "('" + Name + "','" + Code + "','"+telefono+"','"+correo+ "', ?)", conn);           
        ...
        {
            string sql = "SELECT IdImage,Name,Code,Face,telefono,correo FROM UserFaces";
        ...
        public void ConvertImgToBinary(string Name, string Code, Image Img, string telefono, string correo)
        {
            ...
            GuardarImagen(Name, Code, abImagen, telefono,correo);
        }
